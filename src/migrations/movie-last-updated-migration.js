...
;(async () => {
  try {
    ...
    const host = "mongodb+srv://m220student:m220password@cluster0.rxlc3.mongodb.net"
    ...
    const mmoviews = client.db("sample_mflix").collection("movies")
    ...
    const { modifiedCount } = await mmoviews.bulkWrite(moviesToMigrate)
